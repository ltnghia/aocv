    ...
    return (
        <div className="text-justify">
            ...
            <ul className="list-disc list-inside space-y-2 mt-2 mb-8 ml-4">
                <li>Ambiguous object recognition</li>
                <li>Ambiguous object detection</li>
                <li>Ambiguous object segmentation</li>
                <li>Ambiguous object tracking</li>
                <li>Ambiguous object Re-ID</li>
                <li>Ambiguous object generation</li>
